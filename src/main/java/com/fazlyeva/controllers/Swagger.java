...
public class Swagger {
    ...
    public io.swagger.models.Swagger mSwaggerConfig;

    public Swagger() {
        mSwaggerConfig = new io.swagger.models.Swagger();
        mSwaggerConfig.setBasePath("/");
    }

    public Swagger(io.swagger.models.Swagger swagger) {
        this.mSwaggerConfig = swagger;
    }

    protected synchronized io.swagger.models.Swagger scan(Application app) {
    ...
    public Response getListingJson(@Context Application app,
        ...
        io.swagger.models.Swagger swagger = this.mSwaggerConfig;
        if (!initialized) {
        ...
        if (swagger != null) {
            ...
            if (filterImpl != null) {
                ...
                swagger = f.filter(swagger, filterImpl,
                        this.getQueryParams(uriInfo.getQueryParameters()),
